(defproject org.clojars.pkoerner/lisb "0.0.7-SNAPSHOT"
  ...
  :repositories [["snapshot" "https://central.sonatype.com/repository/maven-snapshots/"]
                 ["release" "https://ossrh-staging-api.central.sonatype.com/service/local/"]]
